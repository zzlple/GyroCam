...
public class GyroController : MonoBehaviour
{
    ...
    protected void OnGUI()
    {
        ...
        if (GUILayout.Button("Reset Target", GUILayout.Height(80)))
        {
            ResetTransform();
	...
	{
        targetTransform.position = transform.forward * faraway;

        targetTransform.eulerAngles = new Vector3(targetTransform.eulerAngles.x, transform.eulerAngles.y, targetTransform.eulerAngles.z);
	}
